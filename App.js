  ...
  return (
    <View style={tw`flex-1 items-center justify-center w-full`}>
      <ImageBackground source={image} resizeMode="cover" style={tw`flex-1 justify-center`}>
        ...
        <Text style={tw`w-11/12 self-center text-center text-5xl tracking-widest text-[#fffaf0] font-bold`}> Currency Exchange</Text>
        <Main />
        <Text style={tw`w-11/12 self-center text-center text-base tracking-widest text-[#fffaf0] absolute bottom-5 font-semibold`}> All Rights Reserved By S&S © 2022</Text>
      </ImageBackground>
    </View>
  );
}
